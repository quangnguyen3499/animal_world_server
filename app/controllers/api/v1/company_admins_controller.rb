class Api::V1::CompanyAdminsController < DeviseTokenAuth::RegistrationsController
  ...
  def create
    ...
    @resource.save!
    json_response :ok, serialize_data(CompanyAdminIndexSerializer, @resource), I18n.t("action.success")
  end
